              ...
              >
                <Dialog.Panel className="w-full max-w-sm transform overflow-hidden rounded bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4">
                    <button
                      type="button"
                      className="inline-flex justify-center rounded border border-transparent bg-primary px-4 py-2 text-sm font-medium hover:shadow-[inset_0_0_0_100px_rgba(0,0,0,0.2)] duration-150"
                      onClick={onClose}
                    >
                      {closeBtn}
                    </button>
